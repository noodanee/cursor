...
export function vscodeDarkInit(options) {
    ...
    const { themeOptions, extension } = createTheme({
        theme: theme,
        settings: Object.assign({ background: '#1e1e1e', foreground: 'white', caret: '#c6c6c6', selection: '#264f78f9', selectionMatch: '#b0c6f345', lineHighlight: '#ffffff0f', gutterBackground: '#1e1e1e', gutterForeground: '#838383', gutterActiveForeground: '#fff', fontFamily: 'Menlo, Monaco, Consolas, "Andale Mono", "Ubuntu Mono", "Courier New", monospace' }, settings),

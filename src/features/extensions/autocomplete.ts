...
export const autocompleteView = EditorView.baseTheme({
    ...
    '.cm-completionIcon': {
        ...
        '&.cm-completionIcon-keyword': {
            ...
            backgroundImage: "url(\"data:image/svg+xml,%3Csvg viewBox='0 0 16 16' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M15 4H10V3H15V4ZM14 7H12V8H14V7ZM10 7H1V8H10V7ZM12 13H1V14H12V13ZM7 10H1V11H7V10ZM15 10H10V11H15V10ZM8 2V5H1V2H8ZM7 3H2V4H7V3Z' fill='%23424242' /%3E%3C/svg%3E\")",
            '&:after': {
                content: "' '",
            },
        },

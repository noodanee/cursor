...
export const platformResourcesDir = process.platform === 'win32' ? platDir : path.join(platDir, process.arch);
export const rgLoc = path.join(platformResourcesDir, process.platform === 'win32' ? 'rg.exe' : 'rg');
